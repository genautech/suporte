...
async def run_test():
    ...
    try:
        ...
        # -> Input valid client email into the email field and click 'Enviar Código de Acesso' button to request access code.
        frame = context.pages[-1]
        ...
        frame = context.pages[-1]
        # Click 'Enviar Código de Acesso' button to request access code
